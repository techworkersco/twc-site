...
{% include image.html file=image.file alt='two previosly installed sensors next to a notice with a call to action for students to remove them' caption=null source_link=null half_width=false %}
...
{% include image.html file=image.file alt='A few dozen motion sensor devices arranged on the floor to spell out NO!' caption=null source_link=null half_width=false %}
...
{% include image.html file=image.file alt='A screenshot of an email' caption=null source_link=null half_width=false %}
...
{% include image.html file=image.file alt='A window looking out onto the Boston skyline and a clear blue sky with writing in dry-erase marker that reads, WE ARE NOT DOING ANY SCIENCE HERE - LUZZI' caption=null source_link=null half_width=false %}

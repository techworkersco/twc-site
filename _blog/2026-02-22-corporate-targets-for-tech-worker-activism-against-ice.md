...
At the top of the list is CSI Aviation, famous for **providing deportation flights**, many of which have been, by all accounts, entirely illegal. Also providing similar services is Classic Air Charter. Both are purely private concerns, unlike Avelo airlines, a small commercial carrier, which in a significant victory for anti-ICE protestors, [dropped its ICE contract](https://truthout.org/articles/heres-how-we-pressured-an-airline-to-end-its-contract-with-ice/) in January.

Another group of contractors are those that **run private prisons** – Geo Group, CoreCivic and Management & Training Corporation. The former two are targets of the [Boycott Citizens](https://www.boycottcitizens.org/) campaign, which has targeted Citizens’ Bank for providing them loans and other financial services.
...
Here we have suggested one set of considerations and one source of targets. But the most important thing is to start with talking to your coworkers, researching and planning together, and taking concrete [steps to get organized](https://workerorganizing.org/resources-for-resisting-ice-in-your-workplace-17008/).
